...
class Interfaz:
    def __init__(self):
        ...
        self.pantalla_principal.config(bg='#313131')
        self.componenentes()
        self.menu()
    ...
    def componenentes(self):
        ...
        self.texto_izquierdo.config(height=20, width=45, bg='#131718', border=1, fg='#ffffff',
                               insertbackground='white', font=('Arial', 14), padx=11, wrap='word')
        self.texto_izquierdo.place(x=50,y=120)           
        #---------------------------------
        Analizar = Button(self.pantalla_principal, text='Analizar', font=('Arial', 16), command=self.analizar)
        Analizar.place(x=600, y=150)
    #//////////////////////////////////////////////////////////////////////////////////////////////////////////
    def menu(self):
        self.menu1 = Menu(self.pantalla_principal)
        self.menu1.config(bg='#313131')
        #--------------------------------------------
